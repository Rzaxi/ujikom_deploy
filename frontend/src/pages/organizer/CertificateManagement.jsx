        ...
        {loading ? (
          ...
          <div className="divide-y divide-gray-200">
            {events.map((event) => {
              ...
              const progress = totalParticipants > 0 ? Math.min((totalIssued / totalParticipants) * 100, 100) : 0;
              ...
              {participants.map((participant) => (
                <tr key={participant.user_id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 text-center">
                    <div className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${participant.is_eligible
