...
export const eventsAPI = {
    ...
    // Payment endpoints
    createPayment: (eventId) => api.post(`/payment/events/${eventId}/payment`),
    registerFree: (eventId) => api.post(`/payment/events/${eventId}/register-free`),
    checkPaymentStatus: (orderId) => api.get(`/payment/status/${orderId}`),
};
...
export const paymentAPI = {
    ...
    simulatePayment: (orderId) => api.post(`/payment/simulate-payment/${orderId}`),
};

// Invoice API
export const invoiceAPI = {
    getUserInvoices: () => api.get('/payment/invoices'),
    getById: (invoiceId) => api.get(`/payment/invoices/${invoiceId}`),
    downloadPDF: (invoiceId) => api.get(`/payment/invoices/${invoiceId}/download`, {
        responseType: 'blob'
    }),
};
