...
const storage = multer.diskStorage({
  destination: function (req, file, cb) {
    ...
    if (file.fieldname === 'flyer') {
      uploadPath = path.join(__dirname, '../public/uploads/flyers');
    } else if (file.fieldname === 'certificate_template') {
      uploadPath = path.join(__dirname, '../public/uploads/certificates');
    }
...
router.post('/certificates/regenerate', certificateController.regenerateMissingCertificates);

// Payment tracking routes
const invoiceController = require('../controllers/invoiceController');
router.get('/payments/summary', invoiceController.getOrganizerPaymentSummary);
